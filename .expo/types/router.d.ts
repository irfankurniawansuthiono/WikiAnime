...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(bookmarks)/Bookmarks` | `/(discover)/Discover` | `/(private)` | `/(profile)/Profile` | `/(tabs)` | `/Bookmarks` | `/Details` | `/Discover` | `/Home` | `/Ongoing` | `/Profile` | `/ResetPassword` | `/SearchAnime` | `/SignUp` | `/Upcoming` | `/_sitemap`;
